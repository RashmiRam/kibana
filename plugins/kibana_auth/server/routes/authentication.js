  ...
  const login = function (request, reply) {
    ...
    const loginForm = function (reply) {
      return reply('<!DOCTYPE html><html><head><title>Login Required</title>'
          ...
          + '<h1><img width="100%" ng-src="plugins/kibana_auth/haystack.svg" src="plugins/kibana_auth/haystack.svg"></h1>'
    ...
    if (username || password) {
      ...
      callWithRequest(request, 'search', body).then(
          function (res) {
